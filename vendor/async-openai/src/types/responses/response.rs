...
pub struct CreateResponse {
    ...
    /// Configure server-side context handling such as Responses compaction with
    /// `compact_threshold`. Local fork addition (upstream async-openai has not
    /// wired `ContextManagementParam` into the builder yet).
    #[serde(skip_serializing_if = "Option::is_none")]
