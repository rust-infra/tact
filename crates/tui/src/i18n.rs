...
impl Messages {
    ...
    fn english() -> Self {
        Self {
            ...
            plugin_usage: "Usage: /plugin install <plugin>@<marketplace> | /plugin list | /plugin reload | /plugin marketplace add <source> | /plugin marketplace list | /plugin marketplace update <name> | /plugin marketplace remove <name>",
    ...
    fn chinese() -> Self {
        Self {
            ...
            plugin_usage: "用法：/plugin install <plugin>@<marketplace> | /plugin list | /plugin reload | /plugin marketplace add <source> | /plugin marketplace list | /plugin marketplace update <name> | /plugin marketplace remove <name>",
