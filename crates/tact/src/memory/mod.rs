...
//! ## [`MemoryManager`]
//!
//! Loads, saves, and queries memories.  The `load_memory_prompt` method
//! produces an injectable block for the system prompt.
//!
//! ## Guidance
//!
...
/// YAML frontmatter (`name`, `description`, `type`).  An index file
/// (`MEMORY.md`) is regenerated on every save.
