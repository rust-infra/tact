...
pub struct Messages {
    ...
    // ---- Subagent popup ----
    pub subagent_popup_live_header: &'static str, // " (live, {} 行) "
    pub subagent_popup_done_header: &'static str, // " ({} 行) "
    pub subagent_popup_hint_copy: &'static str,
    pub subagent_popup_hint_scroll: &'static str,
    pub subagent_popup_hint_top_bottom: &'static str,
    pub subagent_popup_hint_follow: &'static str,
    pub subagent_popup_hint_collapse: &'static str,
    pub subagent_popup_hint_close: &'static str,
    pub subagent_popup_thinking_title: &'static str, // "⟳ Thinking"
    pub subagent_popup_lines_footer: &'static str,   // "{} 行"
    pub subagent_popup_tool_footer: &'static str,    // "工具"
...
impl Messages {
    ...
    fn english() -> Self {
        Self {
            ...
            subagent_popup_live_header: " (live, {} lines) ",
            subagent_popup_done_header: " ({} lines) ",
            subagent_popup_hint_copy: " copy ",
            subagent_popup_hint_scroll: " scroll ",
            subagent_popup_hint_top_bottom: " top/bot ",
            subagent_popup_hint_follow: " follow ",
            subagent_popup_hint_collapse: " collapse ",
            subagent_popup_hint_close: " close ",
            subagent_popup_thinking_title: "⟳ Thinking",
            subagent_popup_lines_footer: "{} lines",
            subagent_popup_tool_footer: "tool",
            ...
            plugin_usage: "Usage: /plugin list | /plugin reload | /plugin marketplace list",
    ...
    fn chinese() -> Self {
        Self {
            ...
            subagent_popup_live_header: " (live，{} 行) ",
            subagent_popup_done_header: " ({} 行) ",
            subagent_popup_hint_copy: " 拷贝 ",
            subagent_popup_hint_scroll: " 滚动 ",
            subagent_popup_hint_top_bottom: " 顶/底 ",
            subagent_popup_hint_follow: " 跟随 ",
            subagent_popup_hint_collapse: " 收束块 ",
            subagent_popup_hint_close: " 关闭 ",
            subagent_popup_thinking_title: "⟳ Thinking",
            subagent_popup_lines_footer: "{} 行",
            subagent_popup_tool_footer: "工具",
            palette_title: " 命令面板 /{} ",
            ...
            plugin_usage: "用法：/plugin list | /plugin reload | /plugin marketplace list",
